...
/**
 * JSF converter for {@link Os}.
 * @see GenericJsfConverter
 */
@Named
@Singleton
public class OsJsfConverter extends GenericJsfConverter<Os, Integer> {
    @Inject
    public OsJsfConverter(OsRepository osRepository) {
        super(osRepository, Os.class, Integer.class);
    }
}