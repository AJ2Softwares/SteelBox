...
/**
 * JSF converter for {@link Empresa}.
 * @see GenericJsfConverter
 */
@Named
@Singleton
public class EmpresaJsfConverter extends GenericJsfConverter<Empresa, Integer> {
    @Inject
    public EmpresaJsfConverter(EmpresaRepository empresaRepository) {
        super(empresaRepository, Empresa.class, Integer.class);
    }
}