...
import static br.com.aj2.web.conversation.ConversationHolder.getCurrentConversation;
...
import br.com.aj2.dao.support.JpaUniqueUtil;
...
import br.com.aj2.web.conversation.ConversationCallBack;
import br.com.aj2.web.conversation.ConversationContext;
...
public abstract class GenericController<E extends Identifiable<PK>, PK extends Serializable> {
    ...
    public String create() {
        ...
        ConversationContext<E> ctx = getSelectedContext(newEntity).label("Criar Novo " + newEntity.getClass().getSimpleName());
        return getCurrentConversation().nextContext(ctx).view();
    }
    ...
    protected String edit(E entity) {
        ...
        ConversationContext<E> ctx = getSelectedContext(entity).label("Editando " + printer.print(entity));
        return getCurrentConversation().nextContext(ctx).view();
    }
    ...
    public String view(E entity) {
        ...
        ConversationContext<E> ctx = getSelectedContext(entity).sub().readonly().label("Visualizando" + printer.print(entity));
        return getCurrentConversation().nextContext(ctx).view();
    }
