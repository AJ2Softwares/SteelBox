...
import br.com.aj2.dao.support.OrderBy;
import br.com.aj2.dao.support.OrderByDirection;
...
import br.com.aj2.web.util.PrimeFacesUtil;
...
public abstract class GenericLazyDataModel<E extends Identifiable<PK>, PK extends Serializable, F extends GenericSearchForm<E, PK, F>> extends LazyDataModel<E> {
    ...
    private Boolean rowConditional;
    ...
    public Boolean getRowConditional() {
        return rowConditional;
    }

    public void setRowConditional(Boolean rowConditional) {
        this.rowConditional = rowConditional;
    }
