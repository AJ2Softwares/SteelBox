...
@Entity
@Table(name = "cliente")
public class Cliente implements Identifiable<Integer>, Serializable {
    ...
    private String email; // unique (but null allowed)
    ...
    // Many to one
    private Grupocliente grupoCliente; // (grupoclienteId)
    ...
    public Cliente rgIe(String rgIe) {
        setRgIe(rgIe);
        return this;
    }
    ...
    public Cliente tipoPessoa(TipoPessoa tipoPessoa) {
    ...
    public Cliente facebook(String facebook) {
    ...
    public Cliente skype(String skype) {
        setSkype(skype);
        return this;
    }
    ...
    public Cliente site(String site) {
        setSite(site);
        return this;
    }
    ...
    public Cliente creationDate(Date creationDate) {
    ...
    public Cliente lastModificationAuthor(String lastModificationAuthor) {
    ...
    public Cliente lastModificationDate(Date lastModificationDate) {
    ...
    public Cliente creationAuthor(String creationAuthor) {
    ...
    public Cliente description(String description) {
    ...
    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    // many-to-one: Cliente.grupoclienteId ==> Grupocliente.id
    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    /**
     * Set the {@link #grupoCliente} without adding this Cliente instance on the passed {@link #grupoCliente}
     * If you want to preserve referential integrity we recommend to use
     * instead the corresponding adder method provided by {@link Grupocliente}
     */
    public void setGrupoCliente(Grupocliente grupoCliente) {
        this.grupoCliente = grupoCliente;
    }

    public Cliente grupoCliente(Grupocliente grupoCliente) {
    ...
    public String toString() {
        return Objects.toStringHelper(this) //
                .add(Cliente_.id.getName(), getId()) //
                .add(Cliente_.nome.getName(), getNome()) //
                .add(Cliente_.sexo.getName(), getSexo()) //
                .add(Cliente_.dataNascimento.getName(), getDataNascimento()) //
                .add(Cliente_.estadoCivil.getName(), getEstadoCivil()) //
                .add(Cliente_.cpfCnpj.getName(), getCpfCnpj()) //
                .add(Cliente_.rgIe.getName(), getRgIe()) //
                .add(Cliente_.tipoPessoa.getName(), getTipoPessoa()) //
                .add(Cliente_.logradouro.getName(), getLogradouro()) //
                .add(Cliente_.numero.getName(), getNumero()) //
                .add(Cliente_.complemento.getName(), getComplemento()) //
                .add(Cliente_.bairro.getName(), getBairro()) //
                .add(Cliente_.cidade.getName(), getCidade()) //
                .add(Cliente_.uf.getName(), getUf()) //
                .add(Cliente_.pais.getName(), getPais()) //
                .add(Cliente_.cep.getName(), getCep()) //
                .add(Cliente_.telefone.getName(), getTelefone()) //
                .add(Cliente_.fax.getName(), getFax()) //
                .add(Cliente_.celular.getName(), getCelular()) //
                .add(Cliente_.email.getName(), getEmail()) //
                .add(Cliente_.facebook.getName(), getFacebook()) //
                .add(Cliente_.skype.getName(), getSkype()) //
                .add(Cliente_.msn.getName(), getMsn()) //
                .add(Cliente_.site.getName(), getSite()) //
                .add(Cliente_.creationDate.getName(), getCreationDate()) //
                .add(Cliente_.lastModificationAuthor.getName(), getLastModificationAuthor()) //
                .add(Cliente_.lastModificationDate.getName(), getLastModificationDate()) //
                .add(Cliente_.creationAuthor.getName(), getCreationAuthor()) //
                .add(Cliente_.description.getName(), getDescription()) //
                .toString();
    }
