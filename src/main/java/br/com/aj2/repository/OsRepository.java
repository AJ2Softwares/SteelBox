...
@Named
@Singleton
public class OsRepository extends GenericRepository<Os, Integer> {

    @SuppressWarnings("unused")
    private static final Logger log = LoggerFactory.getLogger(OsRepository.class);
    ...
    @Inject
    public OsRepository(OsDao osDao) {
        super(osDao);
    }
