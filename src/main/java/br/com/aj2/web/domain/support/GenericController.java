...
public abstract class GenericController<E extends Identifiable<PK>, PK extends Serializable> {
    ...
    public String beginSearch() {
        ...
        return beginConversation(newSearchContext(ResourcesUtil.getInstance().getProperty(entityName().toLowerCase())));
    }
    ...
    public String beginCreate() {
        ...
        return beginConversation(newEditContext("Cadastrando " +ResourcesUtil.getInstance().getProperty(entityName().toLowerCase()) ,repository.getNewWithDefaults()));
    }
