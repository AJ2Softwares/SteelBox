...
/**
 * JSF converter for {@link Estudios}.
 * @see GenericJsfConverter
 */
@Named
@Singleton
public class EstudiosJsfConverter extends GenericJsfConverter<Estudios, Integer> {
    @Inject
    public EstudiosJsfConverter(EstudiosRepository estudiosRepository) {
        super(estudiosRepository, Estudios.class, Integer.class);
    }
}