...
/**
 * JSF converter for {@link Locacao}.
 * @see GenericJsfConverter
 */
@Named
@Singleton
public class LocacaoJsfConverter extends GenericJsfConverter<Locacao, Integer> {
    @Inject
    public LocacaoJsfConverter(LocacaoRepository locacaoRepository) {
        super(locacaoRepository, Locacao.class, Integer.class);
    }
}