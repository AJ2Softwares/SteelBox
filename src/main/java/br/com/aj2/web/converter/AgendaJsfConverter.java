...
/**
 * JSF converter for {@link Agenda}.
 * @see GenericJsfConverter
 */
@Named
@Singleton
public class AgendaJsfConverter extends GenericJsfConverter<Agenda, Integer> {
    @Inject
    public AgendaJsfConverter(AgendaRepository agendaRepository) {
        super(agendaRepository, Agenda.class, Integer.class);
    }
}