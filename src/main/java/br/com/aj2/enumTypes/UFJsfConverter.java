...
/**
 * Responsible for creating UF JSF converters required for multiple select! (support null)
 */
@Named
@Singleton
public class UFJsfConverter implements Converter {

    @Override
    public Object getAsObject(FacesContext arg0, UIComponent arg1, String arg2) {
        if (arg2 != null && !arg2.isEmpty()) {
            return UF.valueOf(arg2);
        }
        return null;
    }
