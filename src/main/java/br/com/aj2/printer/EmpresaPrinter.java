...
/**
 * {@link org.springframework.format.Printer} for {@link Empresa} 
 *
...
@Named
@Singleton
public class EmpresaPrinter extends DiscoverablePrinter<Empresa> {
    public EmpresaPrinter() {
        super(Empresa.class);
    }

    @Override
    public String print(Empresa empresa, Locale locale) {
        if (empresa == null) {
            return "";
        }
        StringBuilder ret = new StringBuilder();
        appendIfNotEmpty(ret, empresa.getEmail());
        return ret.toString();
    }
}