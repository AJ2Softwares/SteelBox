...
/**
 * {@link org.springframework.format.Printer} for {@link Produtor} 
 *
...
@Named
@Singleton
public class ProdutorPrinter extends DiscoverablePrinter<Produtor> {
    public ProdutorPrinter() {
        super(Produtor.class);
    }

    @Override
    public String print(Produtor produtor, Locale locale) {
        if (produtor == null) {
            return "";
        }
        StringBuilder ret = new StringBuilder();
        appendIfNotEmpty(ret, produtor.getNome());
        return ret.toString();
    }
}